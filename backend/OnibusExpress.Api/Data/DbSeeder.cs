    ...
    public static void Seed(AppDbContext db)
    {
        ...
        for (int i = 1; i <= 7; i++)
        {
            ...
            db.Viagens.Add(new Viagem
            {
                ...
                RotaId = "1",
                DataHoraPartida = dataAlvo.AddHours(7).AddMinutes(30), // 07:30h
                Preco = 45.00m,
                Capacidade = 46
            });
            ...
            db.Viagens.Add(new Viagem
            {
                Id = (contadorId++).ToString(),
                RotaId = "2",
                DataHoraPartida = dataAlvo.AddHours(14).AddMinutes(0), // 14:00h
                Preco = 45.00m,
                Capacidade = 46
            });
            ...
            if (i % 2 == 0)
            {
                db.Viagens.Add(new Viagem
                {
                    Id = (contadorId++).ToString(),
                    RotaId = "3",
                    DataHoraPartida = dataAlvo.AddHours(19).AddMinutes(15), // 19:15h
                    Preco = 53.00m,
                    Capacidade = 42
                });
            }
